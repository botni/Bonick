...
base='bonitillowizard'
ADDON=xbmcaddon.Addon(id='plugin.program.bonitillowizard')
    
    
VERSION = "1.0.0"


PATH = "bonitillowizard"            

dp           =  xbmcgui.DialogProgress()
dialog       =  xbmcgui.Dialog()
EXCLUDES     = ['plugin.program.bonitillowizard']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/h9eh7a5hj93axui/wizard.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("Bonitillo Builds","Wizard is Whizzing down your Wires ",'', 'Put the kettle on')
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Are you sure?", 'Are you sure you want to wipe this install?', '', 'All addons EXCLUDING Bonitillo Builds Wizard will be completely wiped!', yeslabel='Yes',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
